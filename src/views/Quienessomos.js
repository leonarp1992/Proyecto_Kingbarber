                      ...
                      <div className="row gx-5 justify-content-center">
                          <div className="col-lg-10 col-xl-7">
                              <div className="text-center">
                                  <div className="fs-4 mb-4 fst-italic">En King Barber contamos con 10 años de experiencia prestando los mejores servicios para caballeros,  enfocados en mejorar el estilo de cada uno de nuestros clientes.
                                            ...
                                            Nuestra obsesión es brindar un servicio destacado al cliente, por eso el nivel y energía de nuestro staff son fundamentales para lograr el objetivo principal... ¡tu entera satisfacción!.</div>
