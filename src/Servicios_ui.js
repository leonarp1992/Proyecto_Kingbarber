  ...
  <div>
    <main className="flex-shrink-0">
            ...
            <div class="panel-body" style="margin: 5%;">
                    <div class="d-flex justify-content-center" style="color:white;"><h3>SERVICIOS</h3></div>
                    <div class="table-responsive">
                        <table class="table" style="color: black; align-content: center; width: 100%;" >
                    ...
                    <div class="d-flex justify-content-center" style="color:white;"><h3>AGREGAR SERVICIO</h3></div>
                    <div class="table-responsive">
