        ...
        <main className="flex-shrink-0">
            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div className="panel-body" style={{margin: '5%'}}>
                        <div className="d-flex justify-content-center" style={{color:'white'}}><h3>SERVICIOS</h3></div>
                        ...
                        <div className="d-flex justify-content-center" style={{color:'white'}}><h3>AGREGAR SERVICIO</h3></div>
                        <div className="table-responsive">
