            ...
            <section>
                <div className="panel-body" style={{margin:'5%'}}>
                    <div className="row">
                        <div className="col-lg-6 col-sm-6">
                            ...
                            <table className="table table-sm-responsive" style={{color: 'black', width:'100%', alignContent: 'center' }}>
                                <thead style={{backgroundColor:'#C4C4C4'}}>
                                    <tr>                                            
                                        <th>EMPLEADO</th>
                                        <th colspan="2" style={{textAlign:'center'}}>SERVICIOS</th>                                                       
                                    </tr>
                                </thead>
                        ...
                        <div className="col-lg-6 col-sm-6">
                            <div className="d-flex justify-content-center" style={{color:'white'}}><h3>CREAR AGENDA</h3></div>
                            <table className="table table-sm-responsive" style={{color: 'white', width:'100%', alignContent:'center'}}>
                                <thead>
                                    <tr>                                            
                                    ...
                                    <tr>                                            
                                        ...
                                        <td style={{backgroundColor:'white'}}><select className="form-select" aria-label="select example">
                                            <option>Seleccione una opción</option>
                    ...
                    <div className="d-flex justify-content-center" style={{color:'white'}}><h3>AGENDA DE SERVICIOS</h3></div>
                    ...
                    <div className="d-flex justify-content-center" style={{color:'white'}}><h3>REPORTES</h3></div>
                    <div className="d-flex justify-content-lg-end" style={{alignItems:'center'}}>
                        <label for="" style={{color:'#ffffff'}}>USUARIOS ATENDIDOS</label>
                    ...
                    <div className="d-flex justify-content-lg-end" style={{alignItems:'center'}}>
                        <label for="" style={{color:'#ffffff'}}>INGRESOS</label>
                        <div className="col-lg-2"></div>
                        <label for="colFormLabelExample" className="col-sm-1 col-form-label fw-bolder rounded-2 d-flex justify-content-center" style={{backgroundColor:'#C4C4C4'}}>Buscar</label>
                        <div className="col-sm-2">
                            <input className="form-control form-control" id="colFormLabelExample" placeholder="Búsqueda"/>
                    ...
                    <div className="d-flex justify-content-lg-end" style={{alignItems:'center'}}>
                        <label for="" style={{color:'#ffffff'}}>AGENDA DISPONIBLE</label>
                        <div className="col-lg-2"></div>
                        <label for="colFormLabelExample" className="col-sm-1 col-form-label fw-bolder rounded-2 d-flex justify-content-center" style={{backgroundColor:'#C4C4C4'}}>Buscar</label>
                        <div className="col-sm-2">
                            <input className="form-control form-control" id="colFormLabelExample" placeholder="Búsqueda"/>
